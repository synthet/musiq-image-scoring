...
def create_embedding_router() -> APIRouter:
    ...
    def get_embedding_map(
        folder_path: str | None = Query(None, description="Scope to folder path"),
        ...
        sample_limit: int | None = Query(None, ge=1, le=50000, description="Max images to project"),
