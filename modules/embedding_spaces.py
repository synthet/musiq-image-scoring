...
# Optional culling towers evaluated in the 2026-05-29 spike (all 768-d image
# towers; see docs/reports/CULLING_MODEL_RECOMMENDATION_2026-05-29.md). Not
# generated by default — produced only when listed in ``embeddings.culling_spaces``
# and selectable per level via ``culling.two_level.level*.embedding_space``.
OPENCLIP_L14_IMAGE_SPACE_CODE = "openclip_l14_laion2b_image"
OPENAI_CLIP_L14_IMAGE_SPACE_CODE = "openai_clip_vit_l14_image"
DINOV2_REG_BASE_IMAGE_SPACE_CODE = "dinov2_reg_base_image"
SIGLIP2_BASE_IMAGE_SPACE_CODE = "siglip2_base_image"
CULLING_TOWER_IMAGE_DIM = 768
...
SPACE_DIMS: dict[str, int] = {
    ...
    OPENCLIP_L14_IMAGE_SPACE_CODE: CULLING_TOWER_IMAGE_DIM,
    OPENAI_CLIP_L14_IMAGE_SPACE_CODE: CULLING_TOWER_IMAGE_DIM,
    DINOV2_REG_BASE_IMAGE_SPACE_CODE: CULLING_TOWER_IMAGE_DIM,
    SIGLIP2_BASE_IMAGE_SPACE_CODE: CULLING_TOWER_IMAGE_DIM,
}
