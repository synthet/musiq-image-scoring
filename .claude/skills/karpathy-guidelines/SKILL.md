...
description: >-
  Apply Karpathy's anti-pattern checklist before/during non-trivial coding —
  surface assumptions, resist overcomplication, keep diffs surgical, frame work
  as verifiable goals. Use on ambiguous or multi-step tasks, or when the user
  asks for a "Karpathy pass".
---

# Karpathy guidelines (deliberate coding pass)

The four guardrails in [`.cursor/rules/karpathy-coding.mdc`](../../rules/karpathy-coding.mdc) are
