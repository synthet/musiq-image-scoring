...
For **pipeline / scoring / DB triage** on this product, prefer MCP (`image-scoring-mcp` /
`imgscore-mcp-debug`) for live system evidence; use this skill for **code-path** root cause.
