...
Cherry-picked from [synthet-code-framework](https://github.com/synthet/synthet-code-framework) (Cursor-first fork). See [docs/raw/framework-adoption-port-manifest.md](../docs/raw/framework-adoption-port-manifest.md).
