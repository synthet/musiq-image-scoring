...
| docs-wiki-agent | [`.cursor/skills/docs-wiki/SKILL.md`](../.cursor/skills/docs-wiki/SKILL.md) | Wiki structure, log.md, `/wiki-*` commands | [docs/WIKI_SCHEMA.md](../docs/WIKI_SCHEMA.md), [documentation.mdc](../.cursor/rules/documentation.mdc) |
...
| wsl-ops-agent | [`wsl-environment`](../.cursor/agents/wsl-environment.md), [`wsl-tf-python-runner`](../.cursor/agents/wsl-tf-python-runner.md) | WSL venv provision, long GPU jobs, relay/OOM recovery | [`.cursor/skills/wsl-environment/SKILL.md`](../.cursor/skills/wsl-environment/SKILL.md), [AGENTS.md](../AGENTS.md) |
